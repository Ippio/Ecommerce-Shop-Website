...
import { faMobileScreenButton,faLaptop ,faTabletScreenButton ,faAppleWhole ,faDesktop ,faHeadphones ,faRotateLeft,faHouseLaptop,faSimCard,faUniversalAccess} from '@fortawesome/free-solid-svg-icons'
  ...
  const listNavigation = [
    {
        ...
        listSubMenu: {
            ...
            titleBottom: '',
            listTop: ["Apple(Iphone)","Xiaomi","Nokia","Realme","Samsung","Vivo","Asus","OPPO","Tecno","Masstel"],
            listCenter: ["Apple Watch","Masstel","Huewei","Samsung","Xiaomi","OPPO","Garmin"],
            listBottom: [''],
            titleCost: 'Mức giá',
            listCost: ["Dưới 2 triệu","Từ 2 - 4 triệu","Từ 4- 7 triệu","Từ 7 - 13 triệu","Trên 13 triệu"],
    ...
    },
    {
        ...
        listSubMenu: {
            ...
            titleBottom: 'Máy in',
            listTop: ["Apple(Macbook))","Acer","Dell","Fujitsu","Masstel","Asus","MSI","Microsoft","Chuwi","HP","Lenovo","Gigabyte","Avita"],
            listCenter: ["Diệt virus","Microsoft Office","Windows","Phần mềm khác"],
    ...
    },
    {
        ...
        listSubMenu: {
            ...
            titleCenter: '',
            titleBottom: '',
            listTop: ["Apple(Ipad)","Lenovo","Nexta","Samsung","Xiaomi","Masstel","Coolpad"],
            listCenter: [""],
            listBottom: [""],
            titleCost: 'Mức giá',
            listCost: ["Dưới 2 triệu","Từ 2 - 4 triệu","Từ 4- 7 triệu","Từ 7 - 13 triệu","Trên 13 triệu"],
    ...
    },
    {
        ...
        listSubMenu: {
            ...
            listTop: ["Apple(Iphone)","Xiaomi","Nokia","Realme","Samsung","Vivo","Asus","OPPO","Tecno","Masstel"],
            listCenter: ["Apple Watch","Masstel","Huewei","Samsung","Xiaomi","OPPO","Garmin"],
            listBottom: ["Apple Watch","Masstel","Huewei","Samsung","Xiaomi","OPPO","Garmin"],
            titleCost: 'Mức giá',
            listCost: ["Dưới 2 triệu","Từ 2 - 4 triệu","Từ 4- 7 triệu","Từ 7 - 13 triệu","Trên 13 triệu"],
            titleProduct: 'Bán chạy nhất',
