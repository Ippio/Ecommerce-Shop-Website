...
import {faRibbon,faHardDrive,faTv,faBriefcase,faKeyboard, faBatteryQuarter,faComputerMouse, faMobile , faSdCard, faAppleWhole,faHeadphones,faBroom, faLaptopCode, faBolt, faEllipsis} from '@fortawesome/free-solid-svg-icons'
